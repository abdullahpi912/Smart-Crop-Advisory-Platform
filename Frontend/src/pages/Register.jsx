...
export default function Register({ showToast }) {
  ...
  const [currentStep, setCurrentStep] = useState(() => {
    try {
      const saved = sessionStorage.getItem('cropling_reg_draft') || sessionStorage.getItem('agrisense_reg_draft');
      if (saved) {
              ...
              <div className="auth-step-slide">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.75rem' }}>
                  ...
                  <label htmlFor="terms" style={{ fontSize: '0.86rem', color: 'var(--agri-secondary)', cursor: 'pointer' }}>
                    I agree to the Cropling Farm Terms of Service and Privacy Policy
                  </label>
                </div>
              </div>
            )}
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--agri-secondary)', fontSize: '0.85rem', marginTop: '2px', lineHeight: 1.4 }}>
                    Specify operator name, phone number, and location.
                  </p>
                </div>
              </div>
