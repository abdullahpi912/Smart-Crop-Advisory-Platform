...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <header className="navbar-fixed" role="banner">
        <div className="nav-inner nav-inner-centered">
          ...
          <div className="nav-center-brand">
            <Link className="nav-brand-centered" to="/" onClick={closeSidebar} aria-label="AgriSense Home">
              AGRISENSE
            </Link>
          </div>
                  ...
                  <div className="nav-profile-dropdown" role="menu">
                    <div className="nav-dropdown-header">
                      ...
                      <div className="nav-dropdown-user-details">
                        ...
                        <span className="nav-dropdown-email">{user.email || 'farmer@agrisense.io'}</span>
                      </div>
                    </div>
      ...
      {/* CodingLab Dashboard Sidebar Menu */}
      <nav
        ...
        <header className="cl-header">
          <div className="cl-image-text">
            <span className="cl-image">
              <span className="cl-logo-badge">AS</span>
            </span>

            <div className="cl-text cl-header-text">
              <span className="cl-name">AgriSense</span>
